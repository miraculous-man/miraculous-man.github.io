...
from .views import (
    ...
    dashboard_view, home_page_view, contact, subscribers_messages, delete_message
)


urlpatterns = [
    # Accounts url
    path('admin_page', home_view, name='home'),
    path('', home_page_view, name='homes'),
    ...
    path('messages/', subscribers_messages, name="message_list"),
    path('delete_messages/<int:pk>/delete/', delete_message, name="delete_message"),
